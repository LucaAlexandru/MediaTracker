...
from games.constants import GAME_RATING_TEN, GAME_STATUS_CHOICES, GAME_PLATFORM
...
class Game(models.Model):
    ...
    game_rating = models.CharField(max_length=40, choices=GAME_RATING_TEN, default="unrated")
